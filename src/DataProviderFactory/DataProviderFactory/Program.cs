...
// Now get the connection object.
      using (DbConnection connection = factory.CreateConnection())
      {
        ...
        command.CommandText =
          "Select i.Id, m.Name From Inventory i inner join Make m on m.Id = i.MakeId ";
    ...
    private static DbProviderFactory GetDbProviderFactory(DataProviderEnum provider)
      => provider switch
      {
    ...
    private static (DataProviderEnum Provider, string ConnectionString)
